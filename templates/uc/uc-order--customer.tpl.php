        ...
        <tr valign="top">
          <td>
            ...
            <table cellpadding="4" cellspacing="0" border="0" width="100%"
                   style="font-family: verdana, arial, helvetica; font-size: small;">
              <tr>
                <td colspan="2" bgcolor="#B70A10" style="color: white;">
              ...
              <tr>
                <td colspan="2">
                  ...
                  <table border="0" cellpadding="1" cellspacing="0" width="100%"
                    ...
                    <tr>
                      <td colspan="2">
                        <br/><br/><b><?php print t('Overzicht bestelling:'); ?>&nbsp;</b>
                        ...
                        <table width="100%"
                          ...
                          <table width="100%">
                            <thead>
                            <tr>
                              <strong>Opmerkingen bij de bestelling:</strong>
                            </tr>
                            </thead>

                            <tr>
                              <td><?php print $order_comments; ?></td>
                            </tr>
                          </table>
